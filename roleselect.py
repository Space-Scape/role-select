...
async def role_panel(ctx):
    ...
    custom_emoji_yama = discord.utils.get(guild.emojis, name="yama")
    ...
    button_yama = Button(label="Yama", style=discord.ButtonStyle.secondary, emoji=custom_emoji_yama)
    button_raffle = Button(label="Raffles", style=discord.ButtonStyle.secondary, emoji=custom_emoji_raffle)
